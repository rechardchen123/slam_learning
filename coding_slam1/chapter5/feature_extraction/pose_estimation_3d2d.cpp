...
int main(int argc, char **argv) {
    ...
    //建立3d点
    Mat d1 = imread("../1_depth.png", IMREAD_UNCHANGED);    // 深度图为16位无符号，单通道图像
...
void bundleAdjustment(
    ...
    Block::LinearSolverType *linearSolver = new g2o::LinearSolverCSparse<Block::PoseMatrixType>();  // 线性方程求解
